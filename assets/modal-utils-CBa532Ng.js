(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const q="modulepreload",H=function(e){return"/fitnes_app/"+e},L={},d=function(t,s,o){let r=Promise.resolve();if(s&&s.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),a=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));r=Promise.allSettled(s.map(l=>{if(l=H(l),l in L)return;L[l]=!0;const f=l.endsWith(".css"),v=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${v}`))return;const u=document.createElement("link");if(u.rel=f?"stylesheet":q,f||(u.as="script"),u.crossOrigin="",u.href=l,a&&u.setAttribute("nonce",a),document.head.appendChild(u),f)return new Promise((E,p)=>{u.addEventListener("load",E),u.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(i){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=i,window.dispatchEvent(a),!a.defaultPrevented)throw i}return r.then(i=>{for(const a of i||[])a.status==="rejected"&&n(a.reason);return t().catch(n)})};function g(){const e=document.querySelectorAll(".nav-link"),t=window.location.pathname;e.forEach(s=>{const o=s.closest(".nav-item"),r=s.getAttribute("href").replace("./",""),n=(t==="/"||t.endsWith("index.html"))&&r.includes("index.html"),i=t.endsWith(r)&&r!=="";n||i?o.classList.add("active"):o.classList.remove("active")})}async function W(e){if(!document.startViewTransition){window.location.href=e;return}const s=await(await fetch(e)).text(),r=new DOMParser().parseFromString(s,"text/html"),n=r.querySelector("body").innerHTML,i=r.title;document.startViewTransition(()=>{document.body.innerHTML=n,document.title=i,window.history.pushState({},"",e),g(),O(e)})}const S={"index.html":async()=>{const{fetchQuote:e,fetchMuscles:t}=await d(async()=>{const{fetchQuote:a,fetchMuscles:l}=await Promise.resolve().then(()=>M);return{fetchQuote:a,fetchMuscles:l}},void 0),{initMainHandler:s}=await d(async()=>{const{initMainHandler:a}=await import("./handler-main-DuhYvHle.js");return{initMainHandler:a}},[]);s();const{initModalHandler:o}=await d(async()=>{const{initModalHandler:a}=await import("./handler-modal-DvAeXxIQ.js");return{initModalHandler:a}},[]);o();const{initHandlers:r}=await d(async()=>{const{initHandlers:a}=await import("./handlers-BBbG2hyC.js");return{initHandlers:a}},[]);r();const{initFooterHandler:n}=await d(async()=>{const{initFooterHandler:a}=await import("./handler-footer-gXCxc3Iz.js");return{initFooterHandler:a}},[]);n();const{initAnchorHandler:i}=await d(async()=>{const{initAnchorHandler:a}=await import("./anchor-F9LsAN7P.js");return{initAnchorHandler:a}},[]);i(),g(),e(),t()},"favorites.html":async()=>{const{fetchQuote:e}=await d(async()=>{const{fetchQuote:i}=await Promise.resolve().then(()=>M);return{fetchQuote:i}},void 0),{initFavoritesHandler:t}=await d(async()=>{const{initFavoritesHandler:i}=await import("./handler-favorites-C9-fVA8C.js");return{initFavoritesHandler:i}},[]),{initModalHandler:s}=await d(async()=>{const{initModalHandler:i}=await import("./handler-modal-DvAeXxIQ.js");return{initModalHandler:i}},[]);s();const{initHandlers:o}=await d(async()=>{const{initHandlers:i}=await import("./handlers-BBbG2hyC.js");return{initHandlers:i}},[]);o();const{initFooterHandler:r}=await d(async()=>{const{initFooterHandler:i}=await import("./handler-footer-gXCxc3Iz.js");return{initFooterHandler:i}},[]);r();const{initAnchorHandler:n}=await d(async()=>{const{initAnchorHandler:i}=await import("./anchor-F9LsAN7P.js");return{initAnchorHandler:i}},[]);n(),g(),e(),t()}};async function O(e){const s=new URL(e,window.location.origin).pathname.split("/").pop()||"index.html";console.log(`Initializing page: ${s}`);const o=S[s];if(o)try{await o()}catch(r){console.error(`Error initializing page ${s}:`,r)}else console.warn(`No initializer found for page: ${s}`)}const c="/fitnes_app/assets/sprite-mYoisd9W.svg";function P(e){const t=document.querySelector(".exercise-muscles_list"),s=document.querySelector(".exercise-parts_list"),o=document.querySelector(".exercise-equipment_list");if(!t||!s||!o){console.warn("[renders-index.js] Equipment render elements not found in DOM");return}t.innerHTML="",o.innerHTML="",s.innerHTML="";const r=e.map(n=>`
      ...
      `).join("");o.insertAdjacentHTML("beforeend",r)}function A(e){const t=document.querySelector(".exercise-muscles_list"),s=document.querySelector(".exercise-parts_list"),o=document.querySelector(".exercise-equipment_list");if(!t||!s||!o){console.warn("[renders-index.js] Parts render elements not found in DOM");return}t.innerHTML="",o.innerHTML="",s.innerHTML="";const r=e.map(n=>`
      ...
      `).join("");s.innerHTML=r}function R(e){const t=document.querySelector(".exercise-muscles_list"),s=document.querySelector(".exercise-parts_list"),o=document.querySelector(".exercise-equipment_list");if(!t||!s||!o){console.warn("[renders-index.js] Muscles render elements not found in DOM");return}t.innerHTML="",o.innerHTML="",s.innerHTML="";const r=e.map(n=>`
      ...
      `).join("");t.innerHTML=r}function j(e){const t=document.querySelector(".favorites-wrapper");if(!t)return;if(e===0){t.innerHTML=`
      ...
      `;t.insertAdjacentHTML("beforeend",s)}const $="favorites-exercises";function w(){return JSON.parse(localStorage.getItem($)||"[]")}function y(e){return w().some(o=>o.id===e.id)}function F(e){const t=w(),s=JSON.stringify([...t,e]);localStorage.setItem($,s)}function I(e){const t=w(),s=JSON.stringify(t.filter(o=>o.id!==e.id));localStorage.setItem($,s)}function k(e){const t=document.querySelector(".modal-favorites_btn");t&&t.addEventListener("click",()=>{y(e)?(I(e),h(e.id)):(F(e),h(e.id)),document.dispatchEvent(new Event("favoritesUpdated"))})}function C(e){const t=document.querySelector(".exercise-modal_content");if(!t){console.warn("[renders-modal.js] Modal container not found in DOM");return}t.innerHTML="";const s=y({id:e._id}),o=`
    ...
    `;t.innerHTML=o,k({id:e._id})}function b(e,t){const s=document.querySelector(".exercise-btn-container");if(!s){console.warn("[renders-btn.js] Button container not found in DOM");return}const o=3;let r,n;if(e<=o)r=1,n=e;else{let p=Math.floor(o/2);r=t-p,n=t+p,r<=1&&(r=1,n=o),n>=e&&(r=e-o+1,n=e)}let i="";i+=`
  ...
  `;const l=t===1?"disabled":"",f=Math.max(1,t-1);i+=`
    <button class="exercise-button nav-button" data-page="${f}" ${l}>
      <svg class="test-svg">
  ...
  `,r>1&&(i+='<button class="exercise-button" data-page="1">1</button><span>...</span>');for(let p=r;p<=n;p++){const T=p===Number(t)?"active":"";i+=`<button class="exercise-button ${T}">${p}</button>`}n<e&&(i+=`<span>...</span><button class="exercise-button" data-page="${e}">${e}</button>`);const v=t===e?"disabled":"",u=Math.min(e,t+1);i+=`
    <button class="exercise-button nav-button" data-page="${u}" ${v}>
      <svg class="test-svg">
  ...
  `,s.innerHTML=i}const _="https://your-energy.b.goit.study/api";let V="bodypart",x=1,m=1;async function D(){try{const e=document.querySelector(".article-quote_text"),t=document.querySelector(".article-quote_author");if(!e||!t){console.warn("[fetch.js] Quote elements not found in DOM");return}const o=await(await fetch(`${_}/quote`)).json();e.textContent=o.quote,t.textContent=o.author}catch(e){console.error("Error fetching quote:",e)}}async function B(e=x){try{const s=await(await fetch(`${_}/filters?filter=Muscles&page=${e}&limit=12`)).json();m=s.totalPages,b(m,e),R(s.results)}catch(t){console.error("Error fetching muscles:",t)}}async function U(e=x,t=V){try{const o=await(await fetch(`${_}/exercises?&${t}&page=${e}&limit=10`)).json();m=Math.ceil(o.totalPages/10),b(m,e),A(o.results)}catch(s){console.error("Error fetching parts:",s)}}async function N(e=x){try{const s=await(await fetch(`${_}/filters?filter=Equipment&page=${e}&limit=12`)).json();m=s.totalPages,b(m,e),P(s.results)}catch(t){console.error("Error fetching equipment:",t)}}async function h(e){try{const s=await(await fetch(`${_}/exercises/${e}`)).json();C(s)}catch(t){console.error("Error fetching modal:",t)}}async function z(e=0){try{const s=await(await fetch(`${_}/exercises/${e}`)).json();console.log("Fetched favorite exercise:",s),j(s)}catch(t){console.error("Error fetching modal:",t)}}const M=Object.freeze(Object.defineProperty({__proto__:null,fetchEquipment:N,fetchFavorites:z,fetchModal:h,fetchMuscles:B,fetchParts:U,fetchQuote:D},Symbol.toStringTag,{value:"Module"}));function Q(e){const t=document.querySelector(".exercise-modal");t&&(t.classList.add("is-active"),h(e))}function K(e){const t=e.target.closest(".start-link");if(!t)return!1;e.preventDefault(),e.stopPropagation();const s=t.id;return Q(s),!0}export{U as a,N as b,z as c,I as d,B as f,w as g,K as h,O as i,Q as o,j as r,W as s};
//# sourceMappingURL=modal-utils-CBa532Ng.js.map
